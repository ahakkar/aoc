...
class Crabs:
    ...
    def __init__(self, data:list):
        ...
        """
        self.data:list = data
        self.median:int = int(self.calc_median(data))   
    ...
    def calc_median(self, meas:list) -> float:
        """
        ...
        # even
        if len(meas) % 2 == 0:
            middle1 = meas[int(len(meas)/2-1)]
            middle2 = meas[int(len(meas)/2)]
            median = (middle1+middle2)/2
        # odd
        else:        
            middle = int(len(meas)/2)        
            median = meas[middle]
    ...
    def calc_fuel(self) -> int:
        ...
        for num in self.data:
            fuel += abs(self.median-num)
        return fuel
    
    # part b
    def calc_fuel2(self, pos:int) -> int:
        """
        calculate optimal position compared to median with every crab? 
        pick the least possible option from the pool?
        param : TODO
        return: none
        """
